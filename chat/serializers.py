...
class P2pChatModelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = P2pChatModel
        fields = ('id', 'user', 'user_id','recipient','recipient_id','is_media_present','bucket', 'media_files', 'timestamp', 'body','recipient_profile_url','user_profile_url','is_delete','is_receiver_delete')
