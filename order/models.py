...
class Plan(models.Model):
    ...
    discount_percentage = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, help_text="Discount percentage for the provided cost.")
...
class Coupon(models.Model):
    ...
    discount_percent = models.DecimalField(('Discount Percentage (%)'), max_digits=5, decimal_places=2, validators=[MinValueValidator(0), MaxValueValidator(100)])
