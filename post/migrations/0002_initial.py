...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='post.firstlevelcategory'),
        ),
        migrations.AddField(
            model_name='skeletonpost',
        ...
        migrations.AddField(
            ...
            name='first_category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='firstCat', to='post.firstlevelcategory'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='post',
            name='language',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='post.language'),
        ),
        migrations.AddField(
            model_name='post',
            name='liked_by',
        ...
        migrations.AddField(
            model_name='post',
            name='scope_of_work',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='post.scope'),
        ),
        migrations.AddField(
            model_name='post',
            name='user',
        ...
        migrations.AddField(
            model_name='fourthlevelcategory',
            name='third_category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='firstCatFourth', to='post.thirdlevelcategory'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='bookmark',
            name='skeleton_post',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='post.skeletonpost'),
        ),
        migrations.AddField(
            model_name='bookmark',
            name='user',
