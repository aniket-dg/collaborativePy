...
! function(e) {
        ...
        var t = e(window).width(),
            ...
            a = function(t) {
                ...
                var n, i = 0,
                    ...
                    r = new Array;
                e(t).each(function() {
                    if (n = e(this), e(n).height("auto"), topPostion = n.position().top, a != topPostion) {
                        for (currentDiv = 0; currentDiv < r.length; currentDiv++) r[currentDiv].height(i);
                        r.length = 0, a = topPostion, i = n.height(), r.push(n)
                    } else r.push(n), i = i < n.height() ? n.height() : i;
                    for (currentDiv = 0; currentDiv < r.length; currentDiv++) r[currentDiv].height(i)
                })
            },
            r = function() {
            ...
            l = function() {
                e(".header-nav li").unbind().each(function(t) {
                    if (e("ul", this).length) {
                        var n = e("ul:first", this),
                            i = n.offset().left,
                            a = n.width();
                        e("body").height();
                        i + a <= e("body").width() ? e(this).find(".sub-menu:first").removeClass("left") : e(this).find(".sub-menu:first").addClass("left")
                    }
                })
            },
            s = function() {
        ...
        return {
            init: function() {
                ...
                jQuery(".box-hover").on("mouseenter", function() {
                        ...
                        offset: 50,
                        mobile: !1
                    }).init(), i(), n(), t = jQuery("#quik-search-btn"), a = jQuery("#quik-search-remove"), t.on("click", function() {
                    ...
                    }), jQuery(".mfp-gallery-with-owl").length && jQuery(".mfp-gallery-with-owl").magnificPopup({
                        delegate: ".mfp-link",
                        type: "image",
                    ...
                    }), jQuery(".mfp-video").length && jQuery(".mfp-video").magnificPopup({
                        type: "iframe",
                        iframe: {
                    ...
                    })), jQuery(".dezPlaceAni").length && (e(".dezPlaceAni input, .dezPlaceAni textarea").on("focus", function() {
                        e(this).parents(".form-group, .news-box").addClass("focused")
                    }), e(".dezPlaceAni input, .dezPlaceAni textarea").on("blur", function() {
                        "" == e(this).val() ? (e(this).removeClass("filled"), e(this).parents(".form-group, .news-box").removeClass("focused")) : e(this).addClass("filled")
                        ...
                        if (jQuery(".sticky-header").length > 0) {
                            ...
                            e(window).scrollTop() > t.offset().top ? (t.addClass("is-fixed"), e(".header-Pexp .container > .logo-header .logo").attr("src", "images/logo.png")) : (t.removeClass("is-fixed"), e(".header-Pexp .container > .logo-header .logo").attr("src", "images/logo-white.png"))
                        }
                    }), r(), jQuery('iframe[src*="youtube.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), jQuery('iframe[src*="vimeo.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), jQuery("#image-gallery-mix").length && (jQuery(".gallery-filter").find("li").each(function() {
                    ...
                    function(t) {
                        ...
                        setHeight: !1,
                        axis: "y"
                    }), o(), e(".item-close").on("click", function() {
                        e(this).closest(".cart-item").hide("500")
                    }), e(".cart-btn").unbind().on("click", function() {
                        e(".cart-list").slideToggle("slow")
                    }), e(".full-height").css("height", e(window).height()), u(), jQuery(".heart").length && e(".heart").on("click", function() {
                        e(this).toggleClass("heart-blast")
                    }), l = parseInt(e(".onepage").css("height"), 10), e(".scroll").unbind().on("click", function(t) {
                    ...
                    }), jQuery(".scroll-bar").length > 0 && e(".scroll-bar").unbind().on("click", function(t) {
                        if (t.preventDefault(), "" !== this.hash) {
                            var n = this.hash,
                                i = e(n).offset().top,
                                a = parseInt(e(".onepage").css("height"), 10);
                        ...
                        target: ".navbar",
                        offset: l + 2
                    }), e(".btn-aware").on("mouseenter", function(t) {
                        var n = e(this).offset(),
                            i = t.pageX - n.left,
                            a = t.pageY - n.top;
                    ...
                    function() {
                        if (jQuery("#masonry, .masonry").length) {
                            ...
                            if (jQuery(".card-container").length) {
                                var n = void 0 === t.attr("data-column-width") ? "" : t.attr("data-column-width");
                                "" != n && (n = parseInt(n)), t.imagesLoaded(function() {
                                    t.masonry({
                                        columnWidth: n,
                                        gutterWidth: 15,
                                        isAnimated: !0,
    ...
    jQuery(document).ready(function() {
        ...
        t.onPageloading(), setTimeout(function() {
...
! function(t) {
    ...
    jQuery(document).ready(function() {
        ...
        window.verifyRecaptchaCallback = function(e) {
            ...
            a.preventDefault(), t(".dzFormMsg").html('<div class="gen alert alert-success">Submitting..</div>');
            ...
            t.ajax({
                ...
                dataType: "json",
                success: function(a) {
                    1 == a.status && (e = '<div class="gen alert alert-success">' + a.msg + "</div>"), 0 == a.status && (e = '<div class="err alert alert-danger">' + a.msg + "</div>"), t(".dzFormMsg").html(e), t(".dzForm")[0].reset(), grecaptcha.reset()
                }
            })
        }), setInterval(function() {
            t(".dzFormMsg .alert").hide(1e3)
        }, 1e4), t(".dzSubscribe").on("submit", function(a) {
            a.preventDefault();
            var s = t(this).attr("action"),
                r = t(this).serialize();
            t.ajax({
                ...
                dataType: "json",
                success: function(a) {
                    1 == a.status && (e = '<p style="color: #34A853">' + a.msg + "</p>"), 0 == a.status && (e = '<p style="color: #EA4335">' + a.msg + "</p>"), t(".dzSubscribeMsg").html(e), t(".dzSubscribe")[0].reset()
                }
            })
        }), setInterval(function() {
