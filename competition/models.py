...
class Competion(models.Model):
    ...
    admin_file = models.FileField(upload_to="admin_submissions/",
                                  validators=[FileExtensionValidator(allowed_extensions=['csv', ])], null=True,
                                  blank=True)
...
class UserSubmission(models.Model):
    ...
    user_file = models.FileField(upload_to="user_submissions/",
                                 validators=[FileExtensionValidator(allowed_extensions=['csv', ])], null=True,
                                 blank=True)
