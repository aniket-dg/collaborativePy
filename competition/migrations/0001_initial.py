    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_file', models.FileField(blank=True, null=True, upload_to='admin_submissions/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_file', models.FileField(blank=True, null=True, upload_to='user_submissions/')),
